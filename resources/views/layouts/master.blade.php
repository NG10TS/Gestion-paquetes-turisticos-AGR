...
<body>
    ...
    <div id="main-wrapper">
						...
						<div class="card chat dlab-chat-history-box d-none">
							...
							<div class="card-body msg_card_body dlab-scroll" id="dlab_W_Contacts_Body3">
								...
								<div class="d-flex justify-content-end mb-4">
									...
									<div class="img_cont_msg">
								<img src="{{ asset('assets/images/avatar/2.jpg') }}g" class="rounded-circle user_img_msg" alt="">
									</div>
								</div>
								<div class="d-flex justify-content-start mb-4">
									<div class="img_cont_msg">
        ...
        <div class="footer">
            <div class="copyright">
                <p>Copyright © Designed &amp; Developed by <a href="https://souysoeng.com/" target="_blank">Admin Template</a> 2023</p>
            </div>
        </div>
        <!-- Footer end -->
	</div>
